    ...
    try {
      ...
      if (ctaData.id) {
        ...
        const { error } = await supabase
          .from("cta_section")
          .update({
            title_part1: ctaData.title_part1,
            title_gradient: ctaData.title_gradient,
            description: ctaData.description,
            primary_btn_text: ctaData.primary_btn_text,
            primary_btn_link: ctaData.primary_btn_link,
            secondary_btn_text: ctaData.secondary_btn_text,
            secondary_btn_link: ctaData.secondary_btn_link
          })
          .eq("id", ctaData.id);
